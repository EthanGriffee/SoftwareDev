...
class Array : public Object {
    public:
        ...
        /**
         * Sets the Object at index to to_add
         */
...
class StringArray : public Object {
    public:
        ...
        /**
         * Sets the String at the given index to to_add
         */
...
class IntArray : public Object {
    public:
        ...
        void addAll(IntArray* to_add, size_t index) {
         ...
         /**
         * Sets the Int at the given index to to_add
         */
...
class FloatArray : public Object {
    public:
        ...
        /**
         * Sets the float at the given index to to_add
         */
...
class BoolArray : public Object {
    public:
        ...
        /**
         * Sets the bool at the given index to to_add.
         */
