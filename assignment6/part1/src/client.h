...
/**
 * Represents a client which connects to a server, and recieves directories from the server
 * to connect it to other clients. 
 **/
class Client : public Object {
    public:
        ...
        Directory dir;
         ...
         /**
         * Constructs a client with the ip/port input
         **/
        Client(char* ip, int input_port, char* server_ip, int server_port) {
         ...
         /**
         * Sends a message to the client represented by ip
         **/
...
/**
 *  Represents the thread of a client that accepts and reads messages
 **/
